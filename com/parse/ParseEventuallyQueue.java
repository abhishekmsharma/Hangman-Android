...
abstract class ParseEventuallyQueue {
    ...
    public static class TestHelper {
        ...
        public void clear() {
            this.events.clear();
            this.events.put(1, new Semaphore(MAX_EVENTS));
            this.events.put(2, new Semaphore(MAX_EVENTS));
            this.events.put(3, new Semaphore(MAX_EVENTS));
            this.events.put(4, new Semaphore(MAX_EVENTS));
            this.events.put(5, new Semaphore(MAX_EVENTS));
            this.events.put(6, new Semaphore(MAX_EVENTS));
            this.events.put(7, new Semaphore(MAX_EVENTS));
            this.events.put(8, new Semaphore(MAX_EVENTS));
            for (int i = 0; i < this.events.size(); i++) {
                ((Semaphore) this.events.get(this.events.keyAt(i))).acquireUninterruptibly(MAX_EVENTS);
            }
        }
