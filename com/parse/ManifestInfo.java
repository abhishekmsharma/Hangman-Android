        ...
        synchronized (lock) {
            if (versionCode == -1) {
                try {
                    ...
                    PLog.m3e(TAG, "Couldn't find info about own package", e);
                }
            }
        }
        return versionCode;
