...
class GCMService implements ProxyService {
    ...
    private void onHandleIntent(Intent intent) {
        if (intent != null) {
            ...
            if (REGISTER_RESPONSE_ACTION.equals(action)) {
                ...
                PLog.m2e(TAG, "PushService got unknown intent in GCM mode: " + intent);
            }
        }
    }
    ...
    private void handleGcmPushIntent(Intent intent) {
        ...
        if (messageType != null) {
            PLog.m4i(TAG, "Ignored special message type " + messageType + " from GCM via intent " + intent);
            return;
        }
        ...
        if (dataString != null) {
            try {
                ...
                PLog.m3e(TAG, "Ignoring push because of JSON exception while processing: " + dataString, e);
                return;
            }
        }
