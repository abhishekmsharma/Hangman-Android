...
class OfflineQueryLogic {
    ...
    static class C01821 implements Decider {
        C01821() {
        }
    ...
    static class C01842 implements Decider {
        C01842() {
        }
    ...
    static class C01853 implements Decider {
        C01853() {
        }
    ...
    static class C01864 implements Decider {
        C01864() {
        }
    ...
    static class C01875 implements Decider {
        C01875() {
        }
    ...
    private static Object getValue(Object container, String key, int depth) throws ParseException {
        if (key.contains(".")) {
            ...
            throw new ParseException(ParseException.INVALID_QUERY, String.format("Key %s is invalid.", new Object[]{key}));
    ...
    private static boolean matchesEqualConstraint(Object constraint, Object value) {
        if (constraint == null || value == null) {
            ...
            return compare(constraint, value, new C01821());
        } else {
    ...
    private static boolean matchesRegexConstraint(Object constraint, Object value, String options) throws ParseException {
        ...
        throw new ParseException(ParseException.INVALID_QUERY, String.format("Invalid regex options: %s", new Object[]{options}));
    }
    ...
    private static boolean matchesWithinConstraint(Object constraint, Object value) throws ParseException {
        ...
        if (northeast.getLongitude() < southwest.getLongitude()) {
            throw new ParseException(ParseException.INVALID_QUERY, "whereWithinGeoBox queries cannot cross the International Date Line.");
        } else if (northeast.getLatitude() < southwest.getLatitude()) {
            throw new ParseException(ParseException.INVALID_QUERY, "The southwest corner of a geo box must be south of the northeast corner.");
        } else if (northeast.getLongitude() - southwest.getLongitude() > 180.0d) {
            throw new ParseException(ParseException.INVALID_QUERY, "Geo box queries larger than 180 degrees in longitude are not supported. Please check point order.");
    ...
    private <T extends ParseObject> ConstraintMatcher<T> createNotInQueryMatcher(ParseUser user, Object constraint, String key) {
        ...
        return new ConstraintMatcher<T>(user) {
            ...
            class C01881 implements Continuation<Boolean, Boolean> {
                C01881() {
                }
            ...
            public Task<Boolean> matchesAsync(T object, ParseSQLiteDatabase db) {
                return inQueryMatcher.matchesAsync(object, db).onSuccess(new C01881());
            }
        };
    }
    ...
    private <T extends ParseObject> ConstraintMatcher<T> createDontSelectMatcher(ParseUser user, Object constraint, String key) {
        ...
        return new ConstraintMatcher<T>(user) {
            ...
            class C01901 implements Continuation<Boolean, Boolean> {
                C01901() {
                }
            ...
            public Task<Boolean> matchesAsync(T object, ParseSQLiteDatabase db) {
                return selectMatcher.matchesAsync(object, db).onSuccess(new C01901());
            }
        };
    }
    ...
    static <T extends ParseObject> void sort(List<T> results, State<T> state) throws ParseException {
        ...
        for (String key : state.order()) {
            if (!key.matches("^-?[A-Za-z][A-Za-z0-9_]*$") && !"_created_at".equals(key) && !"_updated_at".equals(key)) {
                throw new ParseException(ParseException.INVALID_KEY_NAME, String.format("Invalid key name: \"%s\".", new Object[]{key}));
            }
        }
    ...
    private Task<Void> fetchIncludeAsync(Object container, String path, ParseSQLiteDatabase db) throws ParseException {
        ...
        if (container instanceof Collection) {
            ...
            return Task.forResult(null).continueWithTask(new Continuation<Void, Task<Object>>() {
                ...
                class C01831 implements Continuation<Void, Object> {
                    C01831() {
                    }
                ...
                public Task<Object> then(Task<Void> task) throws Exception {
                    if (obj instanceof ParseObject) {
                        return OfflineQueryLogic.this.fetchIncludeAsync(obj, null, parseSQLiteDatabase).onSuccess(new C01831());
                    }
