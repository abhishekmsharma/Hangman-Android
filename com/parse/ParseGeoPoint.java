...
public class ParseGeoPoint {
    ...
    static class C02641 implements Continuation<Location, ParseGeoPoint> {
        C02641() {
        }
    ...
    static class C02652 implements Continuation<Location, ParseGeoPoint> {
        C02652() {
        }
    ...
    public static Task<ParseGeoPoint> getCurrentLocationInBackground(long timeout) {
        ...
        return LocationNotifier.getCurrentLocationAsync(Parse.getApplicationContext(), timeout, criteria).onSuccess(new C02641());
    }
    ...
    public static Task<ParseGeoPoint> getCurrentLocationInBackground(long timeout, Criteria criteria) {
        return LocationNotifier.getCurrentLocationAsync(Parse.getApplicationContext(), timeout, criteria).onSuccess(new C02652());
    }
