...
public class ParseAnalytics {
    ...
    private static final Map<String, Boolean> lruSeenPushes = new C00813();

    static class C00813 extends LinkedHashMap<String, Boolean> {
        C00813() {
        }
    ...
    static String getPushHashFromIntent(Intent intent) {
        ...
        try {
            ...
            PLog.m2e(TAG, "Failed to parse push data: " + e.getMessage());
            return pushHash;
        }
    }
}
